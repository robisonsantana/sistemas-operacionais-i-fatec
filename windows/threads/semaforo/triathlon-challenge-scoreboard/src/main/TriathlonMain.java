...
public class TriathlonMain {
	 ...
	 * 
	 * 25 atletas participam da prova e largam juntos, no entanto, apenas 5 armas de tiro estão a disposição. 
	 * Cada atleta leva de 0,5 a 3s por tiro. Conforme os atletas finalizam o circuito de corrida, em ordem 
	 * de chegada, pegam a arma para fazer os disparos. Uma vez encerrados os disparos, a arma é liberada para 
	...
	public static void main(String[] args) {
		...
		for(int idAtleta = 0; idAtleta < 25; idAtleta++) {
			TriathlonController tc = new TriathlonController(idAtleta, semaforo, mutex);
			tc.start();
		}
